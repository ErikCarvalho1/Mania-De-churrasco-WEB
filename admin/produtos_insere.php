...
include_once '../class/porduto.php';
...
if($_POST){
    ...
    $produto->setTipoId( $_POST['id_tipo']);
     $produto->setDestaques( $_POS['destaque']);
      $produto->setTipoId($_POST['descricao']);
       $produto->setTipoId($_POST['resumo']);
        $produto->setTipoId($valor = $_POST['valor']);
         $produto->setTipoId($imagem = $rand.$nome_img);
         if($produto->inserir()){
